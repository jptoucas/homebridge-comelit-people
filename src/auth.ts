 ...
 */
export async function authenticateWithComelit(
  email: string,
  password: string,
  baseURL: string = 'https://api.comelitgroup.com/servicerest',
): Promise<ComelitCredentials> {
 ...
 */
export function isTokenExpired(expirySeconds: number): boolean {
